...
namespace DAL
{
    public class RepositorioUsuarios
    {
        ...
        public Usuario ObtenerUsuario(string username)
        {
            ...
            return new Usuario(parsedId, (string)dr[1], (string)dr[2], (string)dr[3], (string)dr[4], (bool)dr[5]);
        }
        ...
        public List<Usuario> ObtenerListadoTotalUsuarios()
        {
            ...
            {
                Guid parsedId = Guid.Parse(dr[0].ToString());
                list_user.Add(new Usuario(parsedId, (string)dr[1], (string)dr[2], (string)dr[3], (string)dr[4], (bool)dr[5]));
            }
