namespace UI.Modules
{
    partial class GestionUsuariosUI
    {
        ...
        private void InitializeComponent()
        {
            ...
            textBoxRegistroNumTelefono = new TextBox();
            gestionUsuariosUIRegistroLabelNumTelefono = new Label();
            textBoxRegistroEmail = new TextBox();
            gestionUsuariosUIRegistroLabelEmail = new Label();
            textBoxRegistroUsername = new TextBox();
            gestionUsuariosUIRegistroLabelUsername = new Label();
            gestionUsuariosUIGroupBoxListadoUsuarios = new GroupBox();
            gestionUsuariosUIButtonConfirmarEliminarUsuario = new Button();
            dataGridViewListadoUsuarios = new DataGridView();
            gestionUsuariosUIGroupBoxModificacionUsuarios = new GroupBox();
            gestionUsuariosUIModificacionButtonConfirmarModificarUsuario = new Button();
            textBoxModificacionNumTelefono = new TextBox();
            gestionUsuariosUIModificacionLabelNumTelefono = new Label();
            textBoxModificacionEmail = new TextBox();
            gestionUsuariosUIModificacionLabelEmail = new Label();
            gestionUsuariosUIGroupBoxAltaUsuario.SuspendLayout();
            gestionUsuariosUIGroupBoxListadoUsuarios.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)dataGridViewListadoUsuarios).BeginInit();
            gestionUsuariosUIGroupBoxModificacionUsuarios.SuspendLayout();
            SuspendLayout();
            // 
            ...
            gestionUsuariosUIGroupBoxAltaUsuario.Controls.Add(textBoxRegistroNumTelefono);
            gestionUsuariosUIGroupBoxAltaUsuario.Controls.Add(gestionUsuariosUIRegistroLabelNumTelefono);
            gestionUsuariosUIGroupBoxAltaUsuario.Controls.Add(textBoxRegistroEmail);
            ...
            gestionUsuariosUIGroupBoxAltaUsuario.Location = new Point(645, 162);
            ...
            gestionUsuariosUIRegistroLabelConfirmContrasena.Text = "Repetir Contraseña";
            // 
            ...
            gestionUsuariosUIRegistroLabelContrasena.Text = "Contraseña";
            // 
            ...
            gestionUsuariosUIRegistroLabelNumTelefono.Text = "Número de telefono";
            // 
            ...
            gestionUsuariosUIRegistroLabelEmail.Text = "Email";
            // 
            ...
            gestionUsuariosUIRegistroLabelUsername.Text = "Username";
            // 
            ...
            gestionUsuariosUIGroupBoxListadoUsuarios.Size = new Size(610, 457);
            ...
            gestionUsuariosUIButtonConfirmarEliminarUsuario.Click += gestionUsuariosUIButtonConfirmarEliminarUsuario_Click;
            // 
            ...
            gestionUsuariosUIGroupBoxModificacionUsuarios.Location = new Point(645, 12);
            ...
            gestionUsuariosUIModificacionButtonConfirmarModificarUsuario.Click += gestionUsuariosUIModificacionButtonConfirmarModificarUsuario_Click;
            // 
            ...
            gestionUsuariosUIModificacionLabelNumTelefono.Text = "Número de telefono";
            // 
            ...
            gestionUsuariosUIModificacionLabelEmail.Text = "Email";
            // 
            // GestionUsuariosUI
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            ClientSize = new Size(967, 481);
            ControlBox = false;
            ...
            gestionUsuariosUIGroupBoxModificacionUsuarios.ResumeLayout(false);
            gestionUsuariosUIGroupBoxModificacionUsuarios.PerformLayout();
            ResumeLayout(false);
        }
        ...
        private TextBox textBoxRegistroNumTelefono;
        private Label gestionUsuariosUIRegistroLabelNumTelefono;
        private TextBox textBoxRegistroEmail;
        private Label gestionUsuariosUIRegistroLabelEmail;
        private TextBox textBoxRegistroUsername;
        private Label gestionUsuariosUIRegistroLabelUsername;
        private GroupBox gestionUsuariosUIGroupBoxListadoUsuarios;
        private DataGridView dataGridViewListadoUsuarios;
        private Button gestionUsuariosUIButtonConfirmarEliminarUsuario;
        private GroupBox gestionUsuariosUIGroupBoxModificacionUsuarios;
        private Button gestionUsuariosUIModificacionButtonConfirmarModificarUsuario;
        private TextBox textBoxModificacionNumTelefono;
        private Label gestionUsuariosUIModificacionLabelNumTelefono;
        private TextBox textBoxModificacionEmail;
        private Label gestionUsuariosUIModificacionLabelEmail;
    }
}